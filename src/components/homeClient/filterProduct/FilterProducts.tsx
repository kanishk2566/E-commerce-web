...
const FilterProducts = ({products, minPrice, maxPrice, setMinPrice, setMaxPrice, category, setCategory, rating, setRating, toggleFilterModal, resetFilter}: FilterProductsProps) => {
  ...
  return (
    <div className='fixed inset-0 h-screen w-screen bg-black/50 z-101 flex justify-center items-center'>
      ...
      viewport={{ once: true }}
      className='bg-[#f2f2eb] relative p-5 w-10/12 lg:w-1/3 grid grid-cols-3 gap-4 rounded shadow-sm'>
