    ...
    <main className='mx-auto relative py-10 px-5 flex justify-center items-start rounded mt-15 lg:mt-20 mb-20 w-full'>
      ...
      <div className='grid grid-cols-1 gap-10 md:grid-cols-2 w-full'>
        ...
        <div className='flex flex-col gap-3'>
          ...
          <div className='text-xl font-bold bg-gray-200 h-7 w-2/3'/>

          <div className='text-2xl text-[#1c0c0c] font-bold bg-gray-200 h-9 w-20'/>

          <div className='flex flex-col justify-center items-start bg-gray-200 h-4 w-20'/>

          <div className='text-yellow-500 flex justify-center items-center bg-gray-200 h-4 w-20'/>
          ...
          <div className='mt-8 py-3 w-full flex justify-center items-center gap-2 transition-all text-white bg-gray-200 h-12 rounded cursor-pointer'/>
