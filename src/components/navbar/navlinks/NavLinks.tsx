    ...
    <div className='flex justify-center items-center w-full lg:w-fit'>
      ...
      <div className='flex justify-center items-center h-full'>
        ...
        <div className='flex justify-center items-center gap-6 lg:gap-0'>
          ...
          <Link href={"/"} className={`relative flex justify-center items-center px-10 md:px-2 cursor-pointer py-2.5 border-[#f2f2eb] hover:pb-2 hover:bg-[#72383d] hover:rounded-md transition-all  ${pathname === "/" ? "border-b-2 pb-2" : ""}`}>
          ...
          <Link href={"/cart"} className={`relative flex justify-center items-center px-10 md:px-2 cursor-pointer py-2.5 border-[#f2f2eb] hover:pb-2 hover:bg-[#72383d] hover:rounded-md transition-all  ${pathname === "/cart" ? "border-b-2 pb-2" : ""}`}>
          ...
          <Link 
          className={`relative flex justify-center items-center px-10 md:px-2 cursor-pointer py-2.5 border-[#f2f2eb] hover:pb-2 hover:bg-[#72383d] hover:rounded-md transition-all  ${pathname === "/wishlist" ? "border-b-2 pb-2" : ""}`}
          href={"/wishlist"}>
